...
// 根据账号获取账户信息
func (l *GetAccountByAccountLogic) GetAccountByAccount(in *accountDbService.GetByAccountRequest) (*accountDbService.Account, error) {
	...
	return &accountDbService.Account{
		Id:        account.Id,
